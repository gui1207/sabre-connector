...
public class ArrivalDateTime {
    ...
    @java.lang.Override
    public int hashCode() {
        return new HashCodeBuilder().append(timeWindowStart).append(dateTime).append(dateFlexibility).append(timeWindowEnd).append(connectionTimeMax).append(connectionTimeMin).append(timeTolerance).append(maxOptionsPerDate).toHashCode();
    }
