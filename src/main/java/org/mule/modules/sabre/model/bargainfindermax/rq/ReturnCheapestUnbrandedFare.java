...
public class ReturnCheapestUnbrandedFare {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReturnCheapestUnbrandedFare) == false) {
            return false;
        }
        ReturnCheapestUnbrandedFare rhs = ((ReturnCheapestUnbrandedFare) other);
