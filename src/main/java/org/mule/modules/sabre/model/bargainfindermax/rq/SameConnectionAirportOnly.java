...
public class SameConnectionAirportOnly {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SameConnectionAirportOnly) == false) {
            return false;
        }
        SameConnectionAirportOnly rhs = ((SameConnectionAirportOnly) other);
