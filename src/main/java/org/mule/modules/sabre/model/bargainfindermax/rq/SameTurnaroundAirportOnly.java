...
public class SameTurnaroundAirportOnly {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SameTurnaroundAirportOnly) == false) {
            return false;
        }
        SameTurnaroundAirportOnly rhs = ((SameTurnaroundAirportOnly) other);
