...
public class BrandedOneWayItinerary {

    @JsonProperty("TPA_Extensions")
    private TPAExtensions__________ tPAExtensions;
    ...
    @JsonProperty("TPA_Extensions")
    public TPAExtensions__________ getTPAExtensions() {
        return tPAExtensions;
    }

    @JsonProperty("TPA_Extensions")
    public void setTPAExtensions(TPAExtensions__________ tPAExtensions) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BrandedOneWayItinerary) == false) {
            return false;
        }
        BrandedOneWayItinerary rhs = ((BrandedOneWayItinerary) other);
