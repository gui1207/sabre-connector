...
public class BrandedOneWayItinerary_ {

    @JsonProperty("TPA_Extensions")
    private TPAExtensions_____________ tPAExtensions;
    ...
    @JsonProperty("TPA_Extensions")
    public TPAExtensions_____________ getTPAExtensions() {
        return tPAExtensions;
    }

    @JsonProperty("TPA_Extensions")
    public void setTPAExtensions(TPAExtensions_____________ tPAExtensions) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BrandedOneWayItinerary_) == false) {
            return false;
        }
        BrandedOneWayItinerary_ rhs = ((BrandedOneWayItinerary_) other);
