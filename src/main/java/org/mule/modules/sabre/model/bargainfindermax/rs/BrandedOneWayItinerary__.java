...
public class BrandedOneWayItinerary__ {

    @JsonProperty("TPA_Extensions")
    private TPAExtensions________________ tPAExtensions;
    ...
    @JsonProperty("TPA_Extensions")
    public TPAExtensions________________ getTPAExtensions() {
        return tPAExtensions;
    }

    @JsonProperty("TPA_Extensions")
    public void setTPAExtensions(TPAExtensions________________ tPAExtensions) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BrandedOneWayItinerary__) == false) {
            return false;
        }
        BrandedOneWayItinerary__ rhs = ((BrandedOneWayItinerary__) other);
