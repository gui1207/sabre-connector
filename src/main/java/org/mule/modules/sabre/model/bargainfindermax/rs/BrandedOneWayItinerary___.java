...
public class BrandedOneWayItinerary___ {

    @JsonProperty("TPA_Extensions")
    private TPAExtensions___________________ tPAExtensions;
    ...
    @JsonProperty("TPA_Extensions")
    public TPAExtensions___________________ getTPAExtensions() {
        return tPAExtensions;
    }

    @JsonProperty("TPA_Extensions")
    public void setTPAExtensions(TPAExtensions___________________ tPAExtensions) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BrandedOneWayItinerary___) == false) {
            return false;
        }
        BrandedOneWayItinerary___ rhs = ((BrandedOneWayItinerary___) other);
