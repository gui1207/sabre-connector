...
public class OneWayItineraries_ {

    @JsonProperty("BrandedOneWayItineraries")
    private List<BrandedOneWayItinerary_> brandedOneWayItineraries = new ArrayList<BrandedOneWayItinerary_>();
    @JsonProperty("SimpleOneWayItineraries")
    private List<SimpleOneWayItinerary_> simpleOneWayItineraries = new ArrayList<SimpleOneWayItinerary_>();

    @JsonProperty("BrandedOneWayItineraries")
    public List<BrandedOneWayItinerary_> getBrandedOneWayItineraries() {
        return brandedOneWayItineraries;
    }

    @JsonProperty("BrandedOneWayItineraries")
    public void setBrandedOneWayItineraries(List<BrandedOneWayItinerary_> brandedOneWayItineraries) {
        this.brandedOneWayItineraries = brandedOneWayItineraries;
    }

    @JsonProperty("SimpleOneWayItineraries")
    public List<SimpleOneWayItinerary_> getSimpleOneWayItineraries() {
        return simpleOneWayItineraries;
    }

    @JsonProperty("SimpleOneWayItineraries")
    public void setSimpleOneWayItineraries(List<SimpleOneWayItinerary_> simpleOneWayItineraries) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OneWayItineraries_) == false) {
            return false;
        }
        OneWayItineraries_ rhs = ((OneWayItineraries_) other);
