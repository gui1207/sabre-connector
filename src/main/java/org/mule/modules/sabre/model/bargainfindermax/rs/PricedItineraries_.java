...
public class PricedItineraries_ {

    @JsonProperty("TPA_Extensions")
    private TPAExtensions____________ tPAExtensions;
    @JsonProperty("PricedItinerary")
    private List<PricedItinerary> pricedItinerary = new ArrayList<PricedItinerary>();

    @JsonProperty("TPA_Extensions")
    public TPAExtensions____________ getTPAExtensions() {
        return tPAExtensions;
    }

    @JsonProperty("TPA_Extensions")
    public void setTPAExtensions(TPAExtensions____________ tPAExtensions) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PricedItineraries_) == false) {
            return false;
        }
        PricedItineraries_ rhs = ((PricedItineraries_) other);
