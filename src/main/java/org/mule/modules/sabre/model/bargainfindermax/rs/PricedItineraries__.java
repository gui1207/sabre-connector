...
public class PricedItineraries__ {

    @JsonProperty("TPA_Extensions")
    private TPAExtensions_______________ tPAExtensions;
    @JsonProperty("PricedItinerary")
    private List<PricedItinerary> pricedItinerary = new ArrayList<PricedItinerary>();

    @JsonProperty("TPA_Extensions")
    public TPAExtensions_______________ getTPAExtensions() {
        return tPAExtensions;
    }

    @JsonProperty("TPA_Extensions")
    public void setTPAExtensions(TPAExtensions_______________ tPAExtensions) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PricedItineraries__) == false) {
            return false;
        }
        PricedItineraries__ rhs = ((PricedItineraries__) other);
