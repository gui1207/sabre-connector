...
public class SimpleOneWayItinerary {

    @JsonProperty("TPA_Extensions")
    private TPAExtensions___________ tPAExtensions;
    ...
    @JsonProperty("TPA_Extensions")
    public TPAExtensions___________ getTPAExtensions() {
        return tPAExtensions;
    }

    @JsonProperty("TPA_Extensions")
    public void setTPAExtensions(TPAExtensions___________ tPAExtensions) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SimpleOneWayItinerary) == false) {
            return false;
        }
        SimpleOneWayItinerary rhs = ((SimpleOneWayItinerary) other);
