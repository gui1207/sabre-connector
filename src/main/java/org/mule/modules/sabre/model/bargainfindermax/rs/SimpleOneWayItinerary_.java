...
public class SimpleOneWayItinerary_ {

    @JsonProperty("TPA_Extensions")
    private TPAExtensions______________ tPAExtensions;
    ...
    @JsonProperty("TPA_Extensions")
    public TPAExtensions______________ getTPAExtensions() {
        return tPAExtensions;
    }

    @JsonProperty("TPA_Extensions")
    public void setTPAExtensions(TPAExtensions______________ tPAExtensions) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SimpleOneWayItinerary_) == false) {
            return false;
        }
        SimpleOneWayItinerary_ rhs = ((SimpleOneWayItinerary_) other);
