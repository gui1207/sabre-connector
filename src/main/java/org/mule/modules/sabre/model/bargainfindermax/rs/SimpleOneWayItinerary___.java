...
public class SimpleOneWayItinerary___ {

    @JsonProperty("TPA_Extensions")
    private TPAExtensions____________________ tPAExtensions;
    ...
    @JsonProperty("TPA_Extensions")
    public TPAExtensions____________________ getTPAExtensions() {
        return tPAExtensions;
    }

    @JsonProperty("TPA_Extensions")
    public void setTPAExtensions(TPAExtensions____________________ tPAExtensions) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SimpleOneWayItinerary___) == false) {
            return false;
        }
        SimpleOneWayItinerary___ rhs = ((SimpleOneWayItinerary___) other);
