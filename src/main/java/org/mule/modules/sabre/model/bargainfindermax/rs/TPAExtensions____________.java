...
public class TPAExtensions____________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TPAExtensions____________) == false) {
            return false;
        }
        TPAExtensions____________ rhs = ((TPAExtensions____________) other);
