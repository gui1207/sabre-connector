...
public class TPAExtensions_____________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TPAExtensions_____________) == false) {
            return false;
        }
        TPAExtensions_____________ rhs = ((TPAExtensions_____________) other);
