...
public class TPAExtensions______________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TPAExtensions______________) == false) {
            return false;
        }
        TPAExtensions______________ rhs = ((TPAExtensions______________) other);
