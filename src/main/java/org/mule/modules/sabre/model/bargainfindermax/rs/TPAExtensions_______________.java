...
public class TPAExtensions_______________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TPAExtensions_______________) == false) {
            return false;
        }
        TPAExtensions_______________ rhs = ((TPAExtensions_______________) other);
