...
public class TPAExtensions________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TPAExtensions________________) == false) {
            return false;
        }
        TPAExtensions________________ rhs = ((TPAExtensions________________) other);
