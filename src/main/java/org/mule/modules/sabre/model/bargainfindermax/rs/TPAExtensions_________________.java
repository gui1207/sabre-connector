...
public class TPAExtensions_________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TPAExtensions_________________) == false) {
            return false;
        }
        TPAExtensions_________________ rhs = ((TPAExtensions_________________) other);
