...
public class TPAExtensions____________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TPAExtensions____________________) == false) {
            return false;
        }
        TPAExtensions____________________ rhs = ((TPAExtensions____________________) other);
